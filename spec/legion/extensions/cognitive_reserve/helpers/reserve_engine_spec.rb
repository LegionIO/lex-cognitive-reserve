...
RSpec.describe Legion::Extensions::CognitiveReserve::Helpers::ReserveEngine do
  subject(:engine) { described_class.new }

  let(:constants) { Legion::Extensions::CognitiveReserve::Helpers::Constants }
  ...
  describe '#add_pathway' do
    it 'creates a pathway' do
      ...
      expect(pathway).to be_a(Legion::Extensions::CognitiveReserve::Helpers::Pathway)
    end
